...
export const translations = {
  en: {
    ...
    budgetForToday: 'Todays available budget',
    ...
    expenseExceedsWarning: 'This expense exceeds your daily budget.',
    ...
    undoable: 'Esta accion no se puede deshacer.',
    ...
    dailyAllowance: 'Asignacion diaria',
    ...
    // Config
    budgetConfiguration: 'Configuracion de presupuesto',
    ...
    editTransactionDescription: 'Modificar detalles de la transaccion',
    updateTransaction: 'Actualizar transaccion',
    amount: 'Monto',
    description: 'Descripcion',
    account: 'Cuenta',
    selectAccount: 'Selecciona una cuenta',
    expenseExceedsWarning: 'Este gasto excede tu presupuesto diario.',
    whatExpenseFor: 'Para que es este gasto?',
    whatIncomeFor: 'Para que es este ingreso?',
    unnamedExpense: 'Gasto sin nombre',
    unnamedIncome: 'Ingreso sin nombre',
    recentActivity: 'Actividad Reciente',
    recentActivityDescription: 'Tus ultimas transacciones',
    recentExpenses: 'Gastos recientes',
    recentExpensesDescription: 'Tus gastos mas recientes',
    ...
    editAccountDescription: 'Modifica el nombre e icono de tu cuenta',
    accountIcon: 'Icono de cuenta',
    accountNamePlaceholder: 'Escribe un nombre',
    saveChanges: 'Guardar cambios',
    accountUpdated: 'Cuenta actualizada',
    accountUpdatedDescription: 'La cuenta {name} fue actualizada con exito.',
    deleteAccount: 'Eliminar cuenta',
    deleteAccountConfirmation: "Eliminar '{name}'? Esta accion no se puede deshacer.",
    deleteAccountBalance: '{balance} se transferira a tu cuenta de {savings}.',
    delete: 'Eliminar',
    ...
    invalidAmountDescription: 'Por favor ingresa un numero valido',
    accountAdded: 'Cuenta creada',
    accountAddedDescription: 'La cuenta {name} ya esta activa.',
    invalidAccountName: 'Nombre invalido',
    invalidAccountNameDescription: 'Ingresa un nombre valido',
    missingAccounts: 'Faltan cuentas',
    missingAccountsDescription: 'Selecciona cuenta origen y destino',
    invalidTransfer: 'Transferencia invalida',
    ...
    transferCompleteDescription: '{amount} se transfirio correctamente.',
    missingInformation: 'Falta informacion',
