...
export const translations = {
  en: {
    ...
    setupDescription:
      'Enter your starting amount and end date to calculate your daily budget.',
    ...
    addIncomeDescription: 'Add a new income to your budget',
    ...
    deleteAccountBalance:
      'The balance of {balance} will be transferred to your {savings} account.',
    delete: 'Delete',
  ...
  es: {
    ...
    setupDescription:
      'Ingresa tu monto inicial y fecha final para calcular tu presupuesto diario.',
    ...
    addIncomeDescription: 'Agrega un nuevo ingreso a tu presupuesto',
    ...
    deleteAccountBalance:
      'El saldo de {balance} será transferido a tu cuenta de {savings}.',
    delete: 'Eliminar',
